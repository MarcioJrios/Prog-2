<aside class="col-3">
	...
	$sql = "select codp, count(*) as ocorrencias from compra where produto.plataforma = 1, group by codp order by ocorrencias desc limit 3;"; 	// busca os 3 mais pedidos
	$resultado = mysqli_query($conexao, $sql);
	while($lista = mysqli_fetch_array($resultado)){		
		// busca os detalhes de cada um dos 3 mais pedidos
		$sql = "select id, nome, imagem, preco, promocao from produto where codp = {$lista['codp']}";
